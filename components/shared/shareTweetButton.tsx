...
export default function ShareTweetButton({ link }: IProps) {
  return (
    <a
      className="twitter flex rounded-xl px-2 py-1 pl-2 text-xs font-semibold text-white"
      href={link}
      rel="noreferrer"
      target="_blank"
    >
