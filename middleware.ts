...
export default async function middleware(req: NextRequest) {
  ...
  /*  You have to replace ".vercel.pub" with your own domain if you deploy this example under your domain.
      ...
      in this case, our team slug is "platformize", thus *.x-aave.vercel.app works. Do note that you'll
      still need to add "*.x-aave.vercel.app" as a wildcard domain on your Vercel dashboard. */
  const currentHost =
